...
class PutServicesController extends AdminApiBaseController
{
    ...
    public function putServicesAction(Request $request): JsonResponse
    {
        return $this->service->process($request->headers->all(), $request->getContent(), PutServicesDto::class);
    }
}
