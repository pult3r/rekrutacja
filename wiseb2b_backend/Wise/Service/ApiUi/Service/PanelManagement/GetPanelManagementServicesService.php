...
use Wise\Service\ApiUi\Service\PanelManagement\Interfaces\GetPanelManagementServicesServiceInterface;
use Wise\Service\Service\Service\Interfaces\ListServiceServiceInterface;

class GetPanelManagementServicesService extends AbstractGetListUiApiService implements GetPanelManagementServicesServiceInterface
{
    /**
    ...
    public function __construct(
        ...
        private readonly ListServiceServiceInterface $listServiceService,
        private readonly TranslatorInterface $translator,
        private readonly TranslationService $translationService,
        private readonly LocaleServiceInterface $localeService,
        private readonly CurrentUserServiceInterface $currentUserService,
    ){
        parent::__construct($sharedActionService, $listServiceService);
    }
    ...
    protected function prepareElementServiceDtoBeforeTransform(?array &$elementData): void
    {
        ...
        $elementData = [
            ...
            'descriptionFormatted' => empty($elementData['description']) ? null : $this->translationService->getTranslationForField($elementData['description'], $this->localeService->getCurrentLanguage()),
        ];
    }
}
