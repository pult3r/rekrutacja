...
class PatchReceiversController extends AdminApiBaseController
{
    ...
    #[OA\Patch(
        description: 'Modyfikacja listy odbiorców',
        tags: ['Receivers']
    )]
    #[OA\RequestBody(
        required: true,
    ...
    public function patchReceiversAction(Request $request): JsonResponse
    {
        return $this->service->process($request->headers->all(), $request->getContent(), PutReceiversDto::class, true);
    }
}
