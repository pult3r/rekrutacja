...
class PatchCurrencyExchangesController extends AdminApiBaseController
{
    ...
    #[OA\Patch(
        description: 'Modyfikacja listy kursów walut',
    ...
    public function patchCurrencyExchangesAction(Request $request): JsonResponse
    {
        return $this->service->process($request->headers->all(), $request->getContent(), PutCurrencyExchangesDto::class, true);
    }
}
