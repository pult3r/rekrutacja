...
class PutCountriesController extends AdminApiBaseController
{
    ...
    public function putCountriesAction(Request $request): JsonResponse
    {
        return $this->service->process($request->headers->all(), $request->getContent(), PutCountriesDto::class);
    }
}
