...
class PutPanelManagementSupplierService extends AbstractPutUiApiService implements PutPanelManagementSupplierServiceInterface
{
    ...
    public function __construct(
        ...
        private readonly AddOrModifyGpsrSupplierServiceInterface $service,
    ){
