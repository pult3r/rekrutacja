...
class PatchUserCest
{
     ...
     */
    public function correctPatchUser(AdminApiTester $I): void
    {
        $I->wantToTest('PATCH /api/admin/users - Poprawnie dodanie nowego użytkownika. Weryfikacja za pomoca repozytorium i repozytorium ');
        ...
        $responsePatch = $I->sendPatchAsJson('/users', [
            'objects' => [
                $object
            ]
        ]);
        ...
        $I->seeObjectWithElementsInResponse($responsePatch, $object['id'], [
            'id' => $object['id'],
            'message' => 'SUCCESS',
            'status' => 1
        ]);
     ...
     */
    public function correctPatchUserCanModifyExternalId(AdminApiTester $I): void
    {
        $I->wantToTest('PATCH /api/admin/users - Możliwość modyfikacji id zewnętrznego');
        ...
        $I->seeResponseCodeIs(HttpCode::OK);
        $I->seeResponseContainsJson(['status' => 1, 'message' => 'SUCCESS']);
        $userResponseGet = $I->seeObjectWithElementsInResponse($responsePatch, $object['id'], [
            'id' => $object['id'],
            'message' => 'SUCCESS',
            'status' => 1
        ]);
     ...
     * 3. Weryfikacja czy użytkownik został poprawnie zmodyfikowany za pomocą repozytorium
     */
    public function correctPatchUserCanModifyRoles(AdminApiTester $I): void
    {
        $I->wantToTest('PATCH /api/admin/users - Możliwość modyfikacji roli');
        $user = $this->createUser($I);
     ...
     * 3. Weryfikacja czy użytkownik został poprawnie zmodyfikowany za pomocą repozytorium
     */
    public function correctPatchUserCanModifyTrader(AdminApiTester $I): void
    {
        $I->wantToTest('PATCH /api/admin/users - Możliwość modyfikacji sprzedawcy');
        $user = $this->createUser($I);
     ...
     * 3. Weryfikacja czy użytkownik został poprawnie zmodyfikowany za pomocą repozytorium
     */
    public function correctPatchUserCanModifyFirstname(AdminApiTester $I): void
    {
        $I->wantToTest('PATCH /api/admin/users - Możliwość modyfikacji imienia');
        $user = $this->createUser($I);
     ...
     * 3. Weryfikacja czy użytkownik został poprawnie zmodyfikowany za pomocą repozytorium
     */
    public function correctPatchUserCanModifyLastname(AdminApiTester $I): void
    {
        $I->wantToTest('PATCH /api/admin/users - Możliwość modyfikacji nazwiska');
        $user = $this->createUser($I);
     ...
     * 3. Weryfikacja czy użytkownik został poprawnie zmodyfikowany za pomocą repozytorium
     */
    public function correctPatchUserCanModifyEmail(AdminApiTester $I): void
    {
        $I->wantToTest('PATCH /api/admin/users - Możliwość modyfikacji emaila');
        $user = $this->createUser($I);
     ...
     * 3. Weryfikacja czy użytkownik został poprawnie zmodyfikowany za pomocą repozytorium
     */
    public function correctPatchUserCanModifyPhoneNumber(AdminApiTester $I): void
    {
        $I->wantToTest('PATCH /api/admin/users - Możliwość modyfikacji numeru telefonu');
        $user = $this->createUser($I);
     ...
     * 3. Weryfikacja czy użytkownik został poprawnie zmodyfikowany za pomocą repozytorium
     */
    public function correctPatchUserCanModifyIsActive(AdminApiTester $I): void
    {
        $I->wantToTest('PATCH /api/admin/users - Możliwość modyfikacji aktywności użytkownika');
        $user = $this->createUser($I);
     ...
     * @return void
     */
    public function correctPatchUserWithoutRoleId(AdminApiTester $I): void
    {
        ...
        $responsePut = $I->sendPatchAsJson('/users', [
            'objects' => [
                $object
            ]
        ]);
     ...
     * @return void
     */
    public function correctPatchUserWithRoleId(AdminApiTester $I): void
    {
        $I->wantToTest('PATCH /api/admin/users - Poprawne przyznanie roli użytkownika z roleInternalId');
        $object = [
            'id' => $I->generateId('USER'),
            'client_id' => $this->clients[0]->getIdExternal(),
            'login' => $I->generateId('USER'),
     ...
     * @return void
     */
    public function correctPatchUserModificationRoleId(AdminApiTester $I): void
    {
        $I->wantToTest('PATCH /api/admin/users - Poprawne przyznanie podczas modyfikacji roli użytkownika z roleInternalId');
        $object = [
            'id' => $I->generateId('USER'),
            'client_id' => $this->clients[0]->getIdExternal(),
            'login' => $I->generateId('USER'),
