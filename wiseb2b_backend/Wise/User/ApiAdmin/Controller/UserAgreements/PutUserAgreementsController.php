...
class PutUserAgreementsController extends AdminApiBaseController
{
    ...
    public function putUserAgreementsAction(Request $request): JsonResponse
    {
        return $this->service->process($request->headers->all(), $request->getContent(), PutUserAgreementsDto::class);
    }
}
