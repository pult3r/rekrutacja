...
class PatchTradersController extends AdminApiBaseController
{
    ...
    #[OA\Patch(
        description: 'Modyfikacja listy handlowców',
        tags: ['Traders']
    )]
    #[OA\RequestBody(
        required: true,
    ...
    public function patchTradersAction(Request $request): JsonResponse
    {
        return $this->service->process($request->headers->all(), $request->getContent(), PutTradersDto::class, true);
    }
}
