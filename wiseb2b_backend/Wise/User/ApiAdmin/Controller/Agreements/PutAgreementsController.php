...
class PutAgreementsController extends AdminApiBaseController
{
    ...
    public function putAgreementsAction(Request $request): JsonResponse
    {
        return $this->service->process($request->headers->all(), $request->getContent(), PutAgreementsDto::class);
    }
}
