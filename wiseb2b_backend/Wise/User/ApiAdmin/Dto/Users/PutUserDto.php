...
class PutUserDto extends AbstractDto
{
    #[OA\Property(
    ...
    #[Assert\Length(
        max: 255,
        maxMessage: "Id zewnętrzne, może mieć maksymalnie {{ limit }} znaków",
    )]
    protected string $id;
    ...
    #[Assert\Length(
        max: 255,
        maxMessage: "Id zewnętrzne tradera, może mieć maksymalnie {{ limit }} znaków",
    )]
    ...
    #[Assert\Length(
        max: 60,
        maxMessage: "Login użytkownika, może mieć maksymalnie {{ limit }} znaków",
    )]
    ...
    #[Assert\Length(
        max: 255,
        maxMessage: "Hasło użytkownika, może mieć maksymalnie {{ limit }} znaków",
    )]
    ...
    #[Assert\Length(
        max: 255,
        maxMessage: "Adres email, może mieć maksymalnie {{ limit }} znaków",
    )]
    ...
    #[Assert\Length(
        max: 255,
        maxMessage: "Nr telefonu, może mieć maksymalnie {{ limit }} znaków",
    )]
