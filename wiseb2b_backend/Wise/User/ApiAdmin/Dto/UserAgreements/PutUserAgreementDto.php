...
class PutUserAgreementDto extends AbstractDto
{
    #[OA\Property(
    ...
    #[Assert\Length(
        max: 255,
        maxMessage: 'Id zewnętrzne użytkownika, może mieć maksymalnie {{ limit }} znaków',
    )]
    ...
    #[Assert\Length(
        max: 255,
        maxMessage: 'Id zewnętrzne zgody, może mieć maksymalnie {{ limit }} znaków',
    )]
    ...
    #[Assert\Length(
        max: 60,
        maxMessage: 'IP z którego wyrażono zgodę, może mieć maksymalnie {{ limit }} znaków',
    )]
