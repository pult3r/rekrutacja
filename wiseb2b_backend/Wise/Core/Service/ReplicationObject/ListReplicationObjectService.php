...
namespace Wise\Core\Service\ReplicationObject;
...
class ListReplicationObjectService implements ListReplicationObjectServiceInterface
{
    /**
    ...
    protected function prepareJoins(CommonListParams $params, array $filters): array
    {
        ...
        $joins = [];
        if (array_key_exists('replicationRequestId', $fieldsWhichRequireJoin)) {
            $joins[] = new QueryJoin(ReplicationRequest::class, 'replicationRequestId', ['idRequest' => 'replicationRequestId.id']);
        }
