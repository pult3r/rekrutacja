...
namespace Wise\Core\Tests\Unit\ApiUi\Service;
...
use Wise\Security\Service\CoreAutoOverloginUserService;

final class UiApiShareMethodHelperTest extends CommonApiShareMethodHelperTest
{
    ...
    public function _before(): void
    {
        ...
        /** @var CoreAutoOverloginUserService $coreAutoOverloginUserService */
        $coreAutoOverloginUserService = $symfony->grabService(CoreAutoOverloginUserService::class);
        ...
        $this->sharedActionService = new UiApiShareMethodsHelper(
            $serializer,
            $propertyAccessor,
            $objectValidator,
            $repositoryManager,
