...
/**
 * Atrybut OAPatch służy do oznaczania metod lub klas jako operacji PATCH w OpenAPI.
 *
 * Ta klasa rozszerza standardową adnotację OpenAPI `OpenApi\PATCH`, dodając możliwości
 ...
 *
 * @see OpenApi\Patch Dokumentacja OpenAPI dla operacji PATCH.
 *
 * @Attribute(\Attribute::TARGET_CLASS | \Attribute::TARGET_METHOD | \Attribute::IS_REPEATABLE)
 */
#[\Attribute(\Attribute::TARGET_CLASS | \Attribute::TARGET_METHOD | \Attribute::IS_REPEATABLE)]
class OAPatch extends OpenApi\Patch
{
    /**
    ...
    private ?string $requestDtoClass = null;
    ...
    /**
     * Zwraca pole `requestDtoClass` klasy.
     * @return string|null
     */
