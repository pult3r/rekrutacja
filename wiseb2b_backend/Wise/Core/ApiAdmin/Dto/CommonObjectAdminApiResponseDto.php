...
/**
 * DTO deklarujące wynik przetworzenia pojedyńczego obiektu w AdminApi
 * Dotyczy endpointów typu PUT i PATCH
 */
class CommonObjectAdminApiResponseDto extends AbstractDto
{
    #[OA\Property(
    ...
    public function prepareFromData(AbstractDto $dto): void
    {
