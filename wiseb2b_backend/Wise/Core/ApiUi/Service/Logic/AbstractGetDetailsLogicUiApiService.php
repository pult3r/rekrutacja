...
namespace Wise\Core\ApiUi\Service\Logic;
 ...
 *
 *  ## Przykład wykorzystania tej machinki:
 *    - ADMIN API - Wise\Core\Endpoint\Service\ApiAdmin\AbstractGetDetailsAdminApiService [ Tu docelowo umieścić serwis GET Details ADMIN API ]
 *    - UI API - \Wise\Core\Endpoint\Service\ApiUi\AbstractGetDetailsUiApiService [ Tu docelowo umieścić serwis GET Details UI API ]
 */
abstract class AbstractGetDetailsLogicUiApiService extends AbstractUiApiService
{
    /**
