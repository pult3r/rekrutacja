...
/**
 * Klasa zawierający listę obiektów do zwórcenia w każdym zapytaniu GET object w ApiUi
 */

/**
 * @deprecated używać CommonUiApiListResponseDto oraz CommonUiApiDetailsResponseDto w zależności od przeznaczenia danego endpointu
 */
class CommonGetResponseDto extends AbstractResponseDto implements JsonSerializable
{
