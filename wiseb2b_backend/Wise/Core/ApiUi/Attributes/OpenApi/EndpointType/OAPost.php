...
/**
 * Atrybut OAPost służy do oznaczania metod lub klas jako operacji POST w OpenAPI.
 *
 * Ta klasa rozszerza standardową adnotację OpenAPI `OpenApi\Post`, dodając możliwości
 ...
 *
 * @see OpenApi\Post Dokumentacja OpenAPI dla operacji POST.
 *
 * @Attribute(\Attribute::TARGET_CLASS | \Attribute::TARGET_METHOD | \Attribute::IS_REPEATABLE)
 */
#[\Attribute(\Attribute::TARGET_CLASS | \Attribute::TARGET_METHOD | \Attribute::IS_REPEATABLE)]
class OAPost extends OpenApi\Post
{
    /**
