...
class GetPanelManagementClientDto extends CommonUiApiDto
{
    #[OA\Property(
    ...
    protected ?float $tradeCreditTotal = null;

    #[OA\Property(
        description: 'Limit kupiecki do wykorzystania',
        example: 10,
    )]
    protected ?float $tradeCreditFree = null;

    #[OA\Property(
        description: 'Identyfikator klienta potrzebny do autoryzacji',
        example:  'ABCDEFGHIJKLMNOPQRSTUWXYZ1234567890',
    )]
    #[FieldEntityMapping(FieldHandlingEnum::HANDLE_BY_TRANSFER_AND_RETURN_IN_RESPONSE)]
    protected ?string $clientApiId = null;

    #[OA\Property(
        description: 'Sekretny klucz klienta potrzebny do autoryzacji',
        example: 'ABCDEFGHIJKLMNOPQRSTUWXYZ1234567890',
    )]
    #[FieldEntityMapping(FieldHandlingEnum::HANDLE_BY_TRANSFER_AND_RETURN_IN_RESPONSE)]
    protected ?string $clientApiSecret = null;
    ...
    public function getClientApiId(): ?string
    {
        return $this->clientApiId;
    }

    public function setClientApiId(?string $clientApiId): self
    {
    ...
    public function getClientApiSecret(): ?string
    {
        return $this->clientApiSecret;
    }

    public function setClientApiSecret(?string $clientApiSecret): self
    {
