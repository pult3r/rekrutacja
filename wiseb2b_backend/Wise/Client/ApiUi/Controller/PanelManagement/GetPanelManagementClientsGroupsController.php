...
class GetPanelManagementClientsGroupsController extends UiApiBaseController
{
    public function __construct(
        Security $security,
        private readonly GetPanelManagementClientsGroupsServiceInterface $service
    ) {
    ...
    #[OA\Response(
        ...
        content: new OA\JsonContent(ref: "#/components/schemas/GetPanelManagementClientsGroupsResponseDto", type: "object"),
    )]
    #[OA\Response(
