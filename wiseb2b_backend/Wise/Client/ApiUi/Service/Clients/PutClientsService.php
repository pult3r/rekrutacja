...
class PutClientsService extends AbstractPutUiApiService implements PutClientsServiceInterface
{
    protected string $messageSuccessTranslation = 'client.modified';
    ...
    public function __construct(
        ...
        parent::__construct($sharedActionService, $addOrModifyClientService);
    }
