...
class GetPanelManagementClientReceiverService extends AbstractGetDetailsUiApiService implements GetPanelManagementClientReceiverServiceInterface
{
    /**
    ...
    public function __construct(
        ...
        private readonly GetReceiverDetailsServiceInterface $getReceiverDetailsService,
        private readonly GetCountryDetailsServiceInterface $getCountryDetailsService,
        private readonly TranslationService $translationService,
        private readonly LocaleServiceInterface $localeService
    ){
        parent::__construct($sharedActionService, $getReceiverDetailsService);
    }
